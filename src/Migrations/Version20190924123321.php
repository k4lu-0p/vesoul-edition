 ...
 */
final class Version20190924123321 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE book ADD new TINYINT(1) NOT NULL, CHANGE author_id author_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE book DROP new, CHANGE author_id author_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE command CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE image CHANGE book_id book_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE user CHANGE birth birth DATE DEFAULT \'NULL\'');
    }
