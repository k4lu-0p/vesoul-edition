 ...
 */
final class Version20190221155535 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE address (id INT AUTO_INCREMENT NOT NULL, number VARCHAR(10) NOT NULL, type VARCHAR(45) NOT NULL, street VARCHAR(150) NOT NULL, city VARCHAR(150) NOT NULL, cp VARCHAR(10) NOT NULL, country VARCHAR(100) NOT NULL, additional VARCHAR(255) DEFAULT NULL, title VARCHAR(45) NOT NULL, firstname VARCHAR(100) DEFAULT NULL, lastname VARCHAR(100) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
