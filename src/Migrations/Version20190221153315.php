 ...
 */
final class Version20190221153315 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE command (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, relation_livraison_id INT NOT NULL, relation_facturation_id INT NOT NULL, date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', number VARCHAR(150) NOT NULL, quantity INT NOT NULL, totalcost DOUBLE PRECISION NOT NULL, state VARCHAR(150) NOT NULL, INDEX IDX_8ECAEAD4A76ED395 (user_id), INDEX IDX_8ECAEAD4735283E7 (relation_livraison_id), INDEX IDX_8ECAEAD47CD74340 (relation_facturation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
